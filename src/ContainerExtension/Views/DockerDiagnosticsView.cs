...
/// (dockable panel at the bottom of the IDE).
/// </para>
/// <para>
...
                    {
                        Dispatcher.UIThread.Post(ApplySearchFilter);
                    }
                });
            }
            catch (Exception ex)
...
                _ = Task.Run(() =>
                {
                    if (rc != null) { try { rc.Cancel(); rc.Dispose(); } catch { /* ignore */ } }
                    if (sc != null) { try { sc.Cancel(); sc.Dispose(); } catch { /* ignore */ } }
                });
            }
