...
public sealed class ContainerExtensionModule : OneWareModuleBase, IDisposable
{
    ...
    public override void Initialize(IServiceProvider serviceProvider)
    {
        ...
        settingsService.RegisterSetting(SettingsCategoryBinary, SettingsSubCategoryEngine, ExtraFlagsSetting, new TextBoxSetting("Extra Container Labels", "", "Space-separated key=value labels attached to the container (e.g. env=prod team=fpga)."));
